...
<head>
    ...
    <meta name="description"
        content="aplikasi sederhana untuk menampilkan pengumuman hasil ujian nasional secara online">
    <meta name="author" content="Moh. Taufiqur RM">

    <title>E-SKL | Pesantren Tahfizh Al-Qur'an Daarul Hikmah</title>
        ...
        <div class="container">
            ...
            <div id="navbar" class="collapse navbar-collapse">
                ...
                <ul class="nav navbar-nav navbar-right">
                    ...
                    <!--<li><a href="BackUpAndRestore.php">Database</a></li>-->
                    ...
                    <li class="dropdown">
                        ...
                        <ul class="dropdown-menu" role="menu">
                            <li><a href="dataula.php">Tingkat Ula</a></li>
                            <li><a href="dataulya.php">Tingkat Ulya</a></li>
                            <li><a href="datawustha.php">Tingkat Wustha</a></li>
                        </ul>
                    </li>
