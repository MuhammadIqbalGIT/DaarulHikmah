...
<body>
    ...
    <div class="container">
        <h2><b>Data Kelulusan Tingkat Ulya</b></h2>
    </div>
    <div class="row">
        <div class="container">
            <!-- input Cari data -->
            <form action="dataulya.php" method="get">
            ...
            <div class="table table-responsive wrapper">
                <table class="table table-bordered table-hover table-striped table-fixed header-fixed table-fixed head">
                    <thead style="position: sticky; top: 0; z-index: 100; background: white;">
                        <tr class="">
                            <th rowspan="2" style="min-width:40px; vertical-align: middle; text-align: center;">No.</th>
                            ...
                            <th rowspan="2" style="min-width:120px; vertical-align: middle; text-align: center;">NIS
                            </th>
                            <th rowspan="2" style="min-width:120px; vertical-align: middle; text-align: center;">NISN
                            </th>
                            <th rowspan="2" style="min-width:13em; vertical-align: middle; text-align: center;">
                                <a href="<?php $_SERVER['PHP_SELF'] ?>?by=namaa"><span
                                        class="fa fa-arrow-up"></span></a>
                                Nama Siswa
                                <a href="<?php $_SERVER['PHP_SELF'] ?>?by=namab"><span
                                        class="fa fa-arrow-down"></span></a>
                            </th>
                            <th rowspan="2" style="min-width:210px; vertical-align: middle; text-align: center;">Tempat
                                Tanggal Lahir</th>
                            <th rowspan="2" style="min-width:130px; vertical-align: middle; text-align: center;">Nama
                                Orang Tua</th>
                            ...
                            <th colspan="15" class="bg-primary text-center">Nilai Akhir Mata Pelajaran</th>
                            ...
                            <th rowspan="2" style="min-width:80px; vertical-align: middle; text-align: center;">Detail
                                Siswa/Siswi</th>
                        </tr>
                        <tr class="bg-primary">
                            <th>AL-QUR'AN</th>
                    ...
                    <tbody>
                        <?php
                            ...
                            if (isset($_GET['cari'])) {
                                ...
                                $qsiswa = mysqli_query($db_conn, query: "SELECT * FROM data_ulya WHERE no_ujian like '%" . $cari . "%' OR nama like '%" . $cari . "%' OR kls like '%" . $cari . "%' ORDER BY no_ujian ASC");
                            } else if (isset($_GET['by'])) {
                                $sort = $_GET['by'];
                                switch ($sort) {
                                    case 'no_ujiana':
                                        $qsiswa = mysqli_query($db_conn, "SELECT * FROM data_ulya ORDER BY no_ujian ASC");
                                        break;
                                    case 'no_ujianb':
                                        $qsiswa = mysqli_query($db_conn, "SELECT * FROM data_ulya ORDER BY no_ujian DESC");
                                        break;
                                    case 'namaa':
                                        $qsiswa = mysqli_query($db_conn, "SELECT * FROM data_ulya ORDER BY nama ASC");
                                        break;
                                    case 'namab':
                                        $qsiswa = mysqli_query($db_conn, "SELECT * FROM data_ulya ORDER BY nama DESC");
                                        break;
                                    case 'klsa':
                                        $qsiswa = mysqli_query($db_conn, "SELECT * FROM data_ulya ORDER BY kls ASC");
                                        break;
                                    case 'klsb':
                                        $qsiswa = mysqli_query($db_conn, "SELECT * FROM data_ulya ORDER BY kls DESC");
                                        break;
                                    case 'statusa':
                                        $qsiswa = mysqli_query($db_conn, "SELECT * FROM data_ulya ORDER BY status ASC");
                                        break;
                                    case 'statusb':
                                        $qsiswa = mysqli_query($db_conn, "SELECT * FROM data_ulya ORDER BY status DESC");
                                        break;

                                    default:
                                        $qsiswa = mysqli_query($db_conn, "SELECT * FROM data_ulya");
                                        break;
                                }
                            } else {
                                $qsiswa = mysqli_query($db_conn, "SELECT * FROM data_ulya");
                            ...
                            if (mysqli_num_rows($qsiswa) > 0) {
                                while ($data = mysqli_fetch_array($qsiswa)) {
                                    ...
                                    echo '<td class="text-center">' . htmlspecialchars($data['n_sejarah_indonesia']) . '</td>';
                                    ...
                                    echo '<td class="text-center">' . htmlspecialchars($data['n_bahasa_inggris']) . '</td>';
                                    echo '<td class="text-center">' . htmlspecialchars($data['n_ekonomi']) . '</td>';
                                    echo '<td class="text-center">' . htmlspecialchars($data['n_geografi']) . '</td>';
                                    echo '<td class="text-center">' . htmlspecialchars($data['n_sosiologi']) . '</td>';
                                    ...
                                    echo '<td class="text-center">
										<a href="#" 
										   data-toggle="modal" 
										   data-target="#exampleModalLongUlya"
										   ...
										   data-n_sejarah_indonesia="' . htmlspecialchars($data['n_sejarah_indonesia']) . '"
										   data-n_matematika="' . htmlspecialchars($data['n_matematika']) . '"
										   data-n_bahasa_indonesia="' . htmlspecialchars($data['n_bahasa_indonesia']) . '"
										   data-n_bahasa_inggris="' . htmlspecialchars($data['n_bahasa_inggris']) . '"
										   data-n_ekonomi="' . htmlspecialchars($data['n_ekonomi']) . '"
										   data-n_geografi="' . htmlspecialchars($data['n_geografi']) . '"
										   data-n_sosiologi="' . htmlspecialchars($data['n_sosiologi']) . '"
                ...
                <form action="../print/print_ulya.php" method="POST" target="_blank">
        ...
        <!-- Modal Detail Siswa-->
        <div class="modal fade" id="exampleModalLongUlya" tabindex="-1" role="dialog"
            ...
            <div class="modal-dialog" role="document">
                <div class="modal-content">
                    ...
                    <div class="modal-body">
                        ...
                        <form id="formInputData" method="POST" action="edit_data_ulya.php">
                            ...
                            <div class="form-group">
                                <label for="n_sejarah_indonesia">Nilai Sejarah Indonesia</label>
                                <input type="number" step="0.01" class="form-control" id="n_sejarah_indonesia"
                                    name="n_sejarah_indonesia" placeholder="Masukkan Nilai Sejarah Indonesia">
                            </div>
                            <div class="form-group">
                            ...
                            <div class="form-group">
                                <label for="n_bahasa_inggris">Nilai Bahasa Inggris</label>
                                <input type="number" step="0.01" class="form-control" id="n_bahasa_inggris"
                                    name="n_bahasa_inggris" placeholder="Masukkan Bahasa Inggris">
                            </div>
                            <div class="form-group">
                                <label for="n_ekonomi">Nilai Ekonomi</label>
                                <input type="number" step="0.01" class="form-control" id="n_ekonomi" name="n_ekonomi"
                                    placeholder="Masukkan Nilai Ekonomi">
                            </div>
                            <div class="form-group">
                                <label for="n_geografi">Nilai Geografi</label>
                                <input type="number" step="0.01" class="form-control" id="n_geografi" name="n_geografi"
                                    placeholder="Masukkan Nilai Geografi">
                            </div>
                            <div class="form-group">
                                <label for="n_sosiologi">Nilai Sosiologi</label>
                                <input type="number" step="0.01" class="form-control" id="n_sosiologi"
                                    name="n_sosiologi" placeholder="Masukkan Nilai Sosiologi">
                            </div>
        ...
        <script>
        $('#exampleModalLongUlya').on('show.bs.modal', function(event) {
            var button = $(event.relatedTarget); // Button yang diklik
            var modal = $(this);

            // Log data untuk memeriksa apakah data tersedia
            console.log(button.data('id'));
            console.log(button.data('no_ujian'));
            console.log(button.data('nis'));
            ...
            modal.find('#n_sejarah_indonesia').val(button.data('n_sejarah_indonesia'));
            modal.find('#n_matematika').val(button.data('n_matematika'));
            modal.find('#n_bahasa_indonesia').val(button.data('n_bahasa_indonesia'));
            modal.find('#n_bahasa_inggris').val(button.data('n_bahasa_inggris'));
            modal.find('#n_ekonomi').val(button.data('n_ekonomi'));
            modal.find('#n_geografi').val(button.data('n_geografi'));
            modal.find('#n_sosiologi').val(button.data('n_sosiologi'));
        ...
        $('#exampleModalLongUlya').on('show.bs.modal', function(event) {
            ...
            modal.find('.modal-title').html(
                'Detail Data Siswa Siswi Tingkat Ulya <strong>(<span style="font-size: 1.2em;">' +
        ...
        <div class="modal fade" id="exampleModalLongAddSiswa" tabindex="-1" role="dialog"
            ...
            <div class="modal-dialog" role="document">
                <div class="modal-content">
                    <div class="modal-header">
                        <h5 class="modal-title" id="exampleModalLongTitle">Tambah Data Siswa Siswi Tingkat Ulya</h5>
                        <button type="button" class="close" data-dismiss="modal" aria-label="Close">
                            <span aria-hidden="true">&times;</span>
                        </button>
                    </div>
                    <div class="modal-body">
                        <!-- Form untuk menambah data siswa -->
                        <form id="formInputData" method="POST" action="add_data_ulya.php">
                            <div class="form-group">
                                <label for="no_ujian">No Ujian</label>
                                <input type="text" class="form-control" id="no_ujian" name="no_ujian"
                                    placeholder="Masukkan No Ujian">
                            ...
                            <div class="form-group">
                                <label for="n_bahasa_inggris">Nilai Bahasa Inggris</label>
                                <input type="number" step="0.01" class="form-control" id="n_bahasa_inggris"
                                    name="n_bahasa_inggris" placeholder="Masukkan Nilai Bahasa Inggris">
                            </div>
                            <div class="form-group">
                                <label for="n_ekonomi">Nilai Ekonomi</label>
                                <input type="number" step="0.01" class="form-control" id="n_ekonomi" name="n_ekonomi"
                            ...
                            <div class="form-group">
                                <label for="n_sosiologi">Nilai Sosiologi</label>
                                <input type="number" step="0.01" class="form-control" id="n_sosiologi"
                                    name="n_sosiologi" placeholder="Masukkan Nilai Geografi">
                            </div>
