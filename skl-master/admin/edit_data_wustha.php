        ...
        <div class="row justify-content-center">
            <div class="col-md-6">
                <div class="card shadow-lg p-4">
                    <?php
                        // Ambil semua data dari form dengan null coalescing untuk menghindari undefined index
                        $id = $_POST['id'] ?? null;
                    ...
                    <div class="text-center mt-3">
                        <a href="datawustha.php" class="btn btn-primary">Lihat Data</a>
                    </div>
                </div>
            </div>
        </div>
