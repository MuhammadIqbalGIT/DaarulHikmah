...
<script>
var ctx = document.getElementById("myChart_data_ulya").getContext('2d');
var myChart = new Chart(ctx, {
    type: 'bar',
    data: {
        labels: ["Al-Qur'an", "Hadits", "Aqidah", "Akhlaq", "Fiqih", "Sejarah Peradaban Islam", "Bahasa Arab",
            "PPKN",
            "Bahasa Indonesia", "Matematika", "Bahasa Inggris", "Ekonomi", "Geografi", "Sosiologi"
        ],
        datasets: [{
            ...
            data: [
                <?php
                    for ($i = 0; $i < count($nama_field); $i++) {
                        ...
                        $qsiswa = mysqli_query($db_conn, "SELECT AVG($inifield ) AS average FROM data_ulya");
