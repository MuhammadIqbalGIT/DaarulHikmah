...
if (isset($_POST['submit'])) {
    ...
    $hasil = mysqli_query($db_conn, "SELECT * FROM data_ula WHERE no_ujian='$no_ujian'");
...
function printPage() {
    ...
    <body>
                    ...
                    <td>
                        <div class=WordSection1>
                            ...
                            <p>
                                ...
                                <b>70008473</b> Kabupaten Tangerang Selatan Provinsi Banten, menerangkan bahwa :
                            </p>
                            <!-- <ol>
        ...
        Menerangkan bahwa: -->
                            ...
                            <br>
                            dari Pendidikan Kesetaraan Pondok Pesantren Salafiyah Tingkat Ula setelah memenuhi seluruh kriteria sesuai dengan perundang-undangan.
                            <br><br>
                            <center>
